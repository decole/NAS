...
controllers/ApiController - контроллер взаимодействия через вэб интерфейс, использует helpers/mqtt/MqttLogic.
controllers/MqttController - контроллер работы с mqtt - использует helpers/mqtt/MqttLogic для взаимодействия по данному протоколу.

Вынесены функции работы с mqtt и telegram в отдельные классы логики, находятся они в папке /helpers.
